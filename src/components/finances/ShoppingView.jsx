    ...
    return (
        <div className="finances-subview" style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h2 style={{ fontSize: '18px', fontWeight: '700', margin: 0, color: 'var(--text-primary)' }}>Shopping List</h2>
                <span style={{ fontSize: '12px', background: 'var(--accent-gradient)', color: '#fff', padding: '4px 10px', borderRadius: '12px', fontWeight: '600' }}>
